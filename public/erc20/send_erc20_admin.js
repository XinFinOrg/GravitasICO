...
var coinAddress=process.argv[8];
...
var amount  = web3.toWei(sendamount);
var est_main_gas = { from : from_address, to : to_address, value : sendamount };
...
var txdata=web3.eth.contract(coinabi).at(coinAddress).transfer.getData(to_address,amount); //to adress
...
web3.eth.estimateGas(est_main_gas,function(gaslimit_err, gaslimit)
{
    ...
    web3.eth.getGasPrice(function(gas_err, getGasPrice)
    {
        ...
        web3.personal.unlockAccount(from_address, pass, function(lock_err, res)
        {
