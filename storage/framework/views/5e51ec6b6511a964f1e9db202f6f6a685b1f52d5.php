                            ...
                            <div class="col-md-12">
                                ...
                                <div id="generalTabContent" class="tab-content">
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <form action="<?php echo e(url('prashaasak/site_settings')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                        <h3>Site Settings</h3>
                                        <?php echo e(csrf_field()); ?>
                                            ...
                                            <hr/>
                                              ...
                                              <div class="form-group"><label class="col-sm-3 control-label">ETH Address</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                          <div class="col-xs-6"><input type="text" value="<?php echo e(decrypt(get_config('eth_address'))); ?>" class="form-control" readonly="readonly" /></div>
                                                    </div>
                                                </div>
                                            </div>
                                           ...
                                           <!--  <h3>SMTP</h3>
                                              ...
                                              <div class="form-group"><label class="col-sm-3 control-label">SMTP Host</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-6"><input type="text" name="smtp_host" value="<?php echo e(get_config('smtp_host')); ?>" class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">SMTP Port</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-6"><input type="text" name="smtp_port" value="<?php echo e(get_config('smtp_port')); ?>" class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">SMTP Username</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-6"><input type="text" name="smtp_email" value="<?php echo e(get_config('smtp_email')); ?>" class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">SMTP Password</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-6"><input type="text" name="smtp_password" value="<?php echo e(get_config('smtp_password')); ?>" class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div> -->
