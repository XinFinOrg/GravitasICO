                            ...
                            <div class="table-responsive">
                                <table class="table my-wallet-table">
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="item deposit"><a onclick="depositmodall('BTC')"><img src="<?php echo e(URL::asset('front')); ?>/assets/img/deposit.png"> Deposit</a></div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="item deposit"><a onclick="depositmodall('ETH')"><img src="<?php echo e(URL::asset('front')); ?>/assets/img/deposit.png"> Deposit</a></div></td>
                                    ...
                                    <tr>
                                        <td class="title"><div class="item"><img src="<?php echo e(URL::asset('front')); ?>/assets/img/usdt.png"> USDT</div></th>
                                        <td><div class="item"><?php echo e($Bal['USDT']); ?></div></td>
                                        <td><div class="item deposit"><a onclick="depositmodall('USDT')"><img src="<?php echo e(URL::asset('front')); ?>/assets/img/deposit.png"> Deposit</a></div></td>
                                        <td><div class="item withdraw"><a onclick="withdrawalmodal('USDT','<?php echo e($address['USDT']); ?>','<?php echo e($Bal['USDT']); ?>')" disabled="true"><img src="<?php echo e(URL::asset('front')); ?>/assets/img/withdraw.png"> Withdraw</a></div></td>
                                    </tr>
                                    <tr>
                                       <td class="title"><div class="item"><img src="<?php echo e(URL::asset('front')); ?>/assets/img/foodcode23.png">GIFT</div></th>
                                       <td><div class="item"><?php echo e($Bal['GIFT']); ?></div></td>
                                       <td><div class="item deposit"><a onclick="depositmodal('GIFT')"><img src="<?php echo e(URL::asset('front')); ?>/assets/img/deposit.png"> Deposit</a></div></td>
                                       <td><div class="item withdraw"><a onclick="withdrawalmodal('GIFT','<?php echo e($address['GIFT']); ?>','<?php echo e($Bal['GIFT']); ?>')"><img src="<?php echo e(URL::asset('front')); ?>/assets/img/withdraw.png"> Withdraw</a></div></td>
    ...
    <script type="text/javascript">
        ...
        function depositmodall(value) {
            document.getElementById('deposit-header').innerHTML = value + ' Deposit';
                $.ajax({
                    url: '<?php echo e(url("ajax/get_currency_address")); ?>',
                    method: 'post',
        ...
        function depositmodal(value,address)
        {
         console.log(value);
            if(value === 'GIFT')
            {
                toastr.info("Deposit only available for ETH, BTC and USDT");
            }
            else
                {
                    document.getElementById('deposit-header').innerHTML = value+' Deposit';
        ...
        function withdrawalmodal(curr,addr,bal)
        {
         console.log("ddd"+curr);
            if(curr =='ETH' || curr =='BTC'|| curr=='USDT')
            {
