         ...
         <?php echo e(csrf_field()); ?>
                                        ...
                                        <div class="table-container">
                                            ...
                                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               ...
                                               <td>-</td>
                                               <?php else: ?>
                                               <td><?php echo e(get_country_name($val->country)); ?></td>
                                               <?php endif; ?>
                                               <td>
                                               ...
                                               <td>
                                               <a href="<?php echo e(url('admin/status_users/'.$val->id)); ?>" title="status"><i class="fa fa-cog"></i></a>
                                                 <a href="<?php echo e(url('admin/view_users/'.$val->id)); ?>" title="view"><i class="fa fa-eye"></i></a>
                                               </td>
                                               </tr>
