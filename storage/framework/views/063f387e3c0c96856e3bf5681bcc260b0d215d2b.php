                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-success"> <?php echo e($result->Amount); ?> 
                                            <?php if($result->SecondCurrency == 'BTC'): ?> <strong>BTC</strong>
                                            <?php elseif($result->SecondCurrency == 'USDT'): ?> <strong>USDT</strong>
                                            <?php else: ?><strong>ETH</strong><?php endif; ?>
                                            </td>
