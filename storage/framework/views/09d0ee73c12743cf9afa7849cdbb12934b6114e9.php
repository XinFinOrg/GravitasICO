    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="main-content" ui-view="">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title"> FoodCode Platform Crowdsale</div>
                        <hr />
                    </div>
                </div>
                <div class="row md-3">
						...
						<div class="card currency-card-rounded">
							<div class="card-body rounded bitcoin gradient-green">
								<div class="currency-card-icon mt-45 pull-right">
									<i class="fa fa-user-circle-o"><img src="<?php echo e(URL::asset('front')); ?>/assets/img/foodcode.png"></i>
								</div>
								<h5>Token name</h5>
								<h3>FoodCode</h3>
							</div>
					...
					<div class="col-md-3 col-sm-6">
						<div class="card currency-card-rounded">
							<div class="card-body rounded bitcoin gradient-blue">
								<div class="currency-card-icon mt-45 pull-right">
									<i class="fa fa-user-circle-o"><img src="<?php echo e(URL::asset('front')); ?>/assets/img/GIFT.png"></i>
								</div>
								<h5>Symbol</h5>
								<h3>GIFT</h3>
							</div>
                    ...
                    <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                <p>Enter the number of FoodCode (GIFT) tokens you want to buy, choose a cryptocurrency, and see how much you would have to contribute. Alternatively, click on the arrow, enter the amount of cryptocurrency you'd like to spend, and see how many GIFT you'll receive.</p>
