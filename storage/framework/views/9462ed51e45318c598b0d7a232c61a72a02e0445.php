...
<!-- BEGIN LOGIN -->
<div class="content">
    <form id="forgotreset" class="login-form" action="<?php echo e(url('/resetpassword/'.$code)); ?>" method="post">
        ...
        <fieldset >
            ...
            <div class="form-group">
                ...
                <input required  class="form-control form-control-solid placeholder-no-fix" type="email" placeholder="Password" name="password" id="password" />
<br>
                <label class="control-label visible-ie8 visible-ie9">Confirm Password</label>
                <input required  class="form-control form-control-solid placeholder-no-fix" type="email" placeholder="Confirm Password" name="password_confirmation" />
