<?php $__env->startSection("content"); ?>
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        <div class="page-header pull-left">
            ...
            <input type="hidden" id ="url" value="<?php echo e(url('prashaasak/')); ?>">
        </div>
                    ...
                    <div id="table-table-tab" class="tab-pane fade in active">
                                ...
                                <div class="row">
                                    <form id="form_filters" method="get">
                                        ...
                                        <div class="col-md-3">
                                            <a style="margin-top: 17px;" class="btn btn-default" href="<?php echo e(url('/prashaasak/userbalance/')); ?>"><i
                                ...
                                <div class="table-container">
                                    ...
                                    <table class="table table-hover table-striped table-bordered table-advanced tablesorter" id="myTable">
                                        ...
                                        <tr>
                                            ...
                                            <th>Username</th>
                                            <th>UserID</th>
                                            <th>BTC<a href="<?php echo e(url('/prashaasak/userbalance?currency=BTC')); ?>"><i class="fa fa-fw fa-sort pull-right"></i></a></th>
                                            <th>ETH<a href="<?php echo e(url('/prashaasak/userbalance?currency=ETH')); ?>"><i class="fa fa-fw fa-sort pull-right"></i></a></th>
                                            <th>CMB<a href="<?php echo e(url('/prashaasak/userbalance?currency=JCASH')); ?>"><i class="fa fa-fw fa-sort pull-right"></i></a></th>
                                        ...
                                        <?php if($result): ?>
                                            <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($val->CMB); ?></td>
                                                    <?php if($Header == 'User Wallet Balance'): ?>
                                                    <td><a onclick="update_userbal('<?php echo e($val->user_id); ?>','<?php echo e($val->enjoyer_name); ?>','<?php echo e($val->BTC); ?>','<?php echo e($val->ETH); ?>','<?php echo e($val->CMB); ?>')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="userbalupdate" method="post" action="<?php echo e(url('/prashaasak/update_user_balance')); ?>">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label>CMB Amount</label>
                                <input type="text" class="form-control" name="cmb" id="cmb">
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $.getJSON(url+"/total_userbalance",function(result){
                anchor.title = 'Total BTC: '+result.BTC+
                    ...
                    ' Admin ETH: '+result.Admin_ETH+'\nTotal JCASH: '+result.CMB+
                    ' Admin JCASH: '+result.Admin_JCASH;
            });
        ...
        function update_userbal(user_id,name,btc,eth,jcash)
        {
            ...
            var Xdce = document.getElementById('cmb');
            var header = document.getElementById('header');
            header.innerHTML = "Edit "+name+" Balance";
            Btc.placeholder = btc;
            Btc.value = btc;
            Xdce.placeholder = jcash;
            Xdce.value = jcash;
            Eth.placeholder = eth;
            Eth.value = eth;
