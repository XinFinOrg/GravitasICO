...
<body id="signin-page">
<div class="page-form">
    <form action="<?php echo e(url('/admin')); ?>" class="form" method="post">
...
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    ...
    <?php endif; ?>
        <div class="body-content">
            ...
            <hr>
            <p>Forgotten your Password? <a id="btn-register" href="<?php echo e(url('admin/forgot')); ?>">Forgot Now</a></p></div>
    </form>
</div>
 ...
 function word()
{
    ...
    $.ajax({
        type:'post',
        url:'<?php echo e(url("admin/checkpattern")); ?>',
