            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <?php if(Session::get('alpha_id') == 1): ?>
                        ...
                        <li class="<?php echo e(admin_class('cms')); ?>"><a href="<?php echo e(url('prashaasak/cms')); ?>"><i class="fa fa-file-text fa-fw">
                                    <div class="icon-bg bg-orange"></div>
                        ...
                        <li class="<?php echo e(admin_class('contact_query')); ?>"><a href="<?php echo e(url('prashaasak/contact_query')); ?>"><i class="fa fa-phone fa-fw">
                                    <div class="icon-bg bg-orange"></div>
                                </i><span class="menu-title">Manage Enquiry</span></a></li>

                        <li class="<?php echo e(admin_class('whitelists')); ?>"><a href="<?php echo e(url('prashaasak/whitelists')); ?>"><i class="fa fa-ban fa-fw">
                                    <div class="icon-bg bg-orange"></div>
                                </i><span class="menu-title">Manage IP Whitelists</span></a></li>

                        <li class="<?php echo e(admin_class('meta_content')); ?>"><a href="<?php echo e(url('prashaasak/meta_content')); ?>"><i class="fa fa-file-text fa-fw">
                                    <div class="icon-bg bg-orange"></div>
