                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group-mobile">
                                            <select class="form-control input-lg mobile_code_dropdown" id="isdcode" name="isdcode">
                                                <?php $__currentLoopData = $country_code; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group radio-group">
                                            <label for="gender" class="gender-main-label">Gender  </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="gender" class="gender-list">
                                                <span class="male-female">Male</span><span class="checkmark"></span>
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="gender" class="gender-list"><span class="male-female">Female</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <img width="350" height="250" style="border:1px solid #d3d3d3;" src="<?php echo e(URL::asset('front')); ?>/assets/img/idcard-f.jpg">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12 ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <span style="padding-toptop: 250px">Example</span>
                                            <img width="350" height="250" style="border:1px solid #d3d3d3;" src="<?php echo e(URL::asset('front')); ?>/assets/img/idcard-b.jpg">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-12 ">
                                    ...
                                    <br>
                                    <span>Please provide a photo of you holding your Identity Card front side. In the same picture, make a reference to CMB and today's date displayed. Make sure your face is clearly visible and that all passport details are clearly readable.</span>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <span style="padding-toptop: 250px">Example</span>
                                            <img width="350" height="250" style="border:1px solid #d3d3d3;" src="<?php echo e(URL::asset('front')); ?>/assets/img/idcard-h.jpg">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <p>KYC verification would need 1 - 3 working days to be complete.</p>
                                    <br>
                                </div>
                                </form>
                            </div>
...
<?php $__env->startSection('xscript'); ?>
    ...
    <script src="<?php echo e(URL::asset('front')); ?>/assets/js/countrySelect.js"></script>
