        ...
        <div class="row">
            <div class="col-sm-6 res-l-bttm">
                <ul class="social text-left centttr">
                    ...
                    <li class="animated" data-animate="fadeInUp" data-delay=".5"><a href="https://www.jiojio.io/about-jiojiome.html" target="_blank">
                            <div class="cards"><img src="{{URL::asset('front')}}/assets/images/jio-icon2.png" alt="" class="imgf"><img src="{{URL::asset('front')}}/assets/images/jio-icon2-h.png" alt="" class="img-top"></div></a></li>
            ...
            <div class="col-sm-6">
                <div class="text-right centttr">
                    <a href="https://itunes.apple.com/in/app/jiojiome/id1255725245?mt=8" target="_blank"><img src="{{URL::asset('front')}}/assets/images/ipn1.png" alt=""></a>
                    &nbsp; <a href="https://play.google.com/store/apps/details?id=com.jiojiome&amp;hl=en" target="_blank"><img src="{{URL::asset('front')}}/assets/images/gpl1.png" alt=""></a>
                </div>
            </div>
