...
<li class="nav-item start ">
    <a href="index.html" class="nav-link ">
        ...
        <span class="title">Dashboard </span>
            ...
            <li class="nav-item start open">
                <a href="{{url('/ico')}}" class="nav-link nav-toggle">
            ...
            <li class="nav-item start open" ui-sref="main.distribution">
                <a href="{{url('/distribution')}}" class="nav-link nav-toggle">
            ...
            <li class="nav-item start open" >
                <a href="{{url('/documents')}}" class="nav-link nav-toggle">
            ...
            <li class="nav-item start open" >
                <a href="{{url('/wallets')}}" class="nav-link nav-toggle">
            ...
            <li class="nav-item start open">
                <a href="{{url('/kyc')}}" class="nav-link nav-toggle">
