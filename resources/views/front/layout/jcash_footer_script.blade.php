...
<script src="{{URL::asset('front')}}/assets/js/jquery.bundle2.js"></script>
<script src="{{URL::asset('front')}}/assets/js/new-script.js"></script>
<script src="{{URL::asset('front')}}/assets/js/index.js"></script>
<script src="{{URL::asset('front')}}/assets/js/jquery-ss.min.js"></script>
<script src="{{URL::asset('front')}}/assets/js/accodian2.js"></script>
...
<script src="{{URL::asset('front')}}/assets/js/particles-jjc2.js"></script>
<script src="{{URL::asset('front')}}/assets/js/particles-jjc1-ne.js"></script>
<script src="{{URL::asset('front')}}/assets/js/particles-jjcs1.js"></script>
<script src="{{URL::asset('front')}}/assets/js/fallingsnow.js"></script>
<script src="{{URL::asset('front')}}/assets/js/prefixfree.min.js"></script>
