...
<head>
    ...
    <link href="{{URL::asset('front')}}/assets/css/toastr-2.1.3.css" rel="stylesheet" />
    <style type="text/css">
        .error {
            color: #a94442;
...
<div class="content">
    <!-- BEGIN LOGIN FORM -->
    <form id="login_form" action="{{url('/login')}}" class="login-form" method="post" name="login-form">
    {{ csrf_field() }}<!--ng-submit="login()"-->
        <fieldset ng-disabled="loading">
            <h3 class="font-green">Login</h3>
            <div class="form-title">
                <span class="form-title">Welcome to Gravitas.</span><br>
                {{--<span class="hint">Please login.</span>--}}
            </div>
        ...
        Enter any username and password.
            ...
            <div class="form-actions">
                <div class="pull-right forget-password-block">
                    <a href="{{url('/forgotpass')}}" class="forget-password">Forgot Password?</a>  <!--ui-sref="auth.accountRecovery"-->
                </div>
            </div>
