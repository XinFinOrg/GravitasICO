						...
						<div class="card currency-card-rounded">
							<div class="card-body rounded bitcoin gradient-green">
								<div class="currency-card-icon mt-45 pull-right">
									<i class="fa fa-user-circle-o"><img src="{{URL::asset('front')}}/assets/img/gravitas.png"></i>
								</div>
								<h5>Token name</h5>
								<h3>Gravitas</h3>
							</div>
					...
					<div class="col-md-3 col-sm-6">
						<div class="card currency-card-rounded">
							<div class="card-body rounded bitcoin gradient-orange">
								<div class="currency-card-icon mt-45 pull-right">
									<i class="fa fa-user-circle-o"><img src="{{URL::asset('front')}}/assets/img/total-issued.png"></i>
								</div>
								<h5>Total issued</h5>
					...
					<div class="col-md-3 col-sm-6">
						<div class="card currency-card-rounded">
							<div class="card-body rounded bitcoin gradient-pink">
								<div class="currency-card-icon mt-45 pull-right">
									<i class="fa fa-user-circle-o"><img src="{{URL::asset('front')}}/assets/img/total-sale.png"></i>
								</div>
                    ...
                    <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body">
                                ...
                                <p>The rate is updated every 5 minutes</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-d-3 col-xs-12 col-sm-12">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body text-center">
                                ...
                                {{--<p>--}}
                                    {{--Next round begins in <strong> 28 Days 6 Hours </strong>--}}
                                {{--</p>--}}
                                {{--<p>--}}
                                    {{--<strong> USD RAISED: 456542.97678992</strong>--}}
                                {{--</p>--}}
                            </div>
                        </div>
                    </div>
