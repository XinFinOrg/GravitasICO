                ...
                <div class="col-md-12">
                    <div class="panel panel-default noBorder">
                        ...
                        <div class="panel-body">
                            <h4 class="uppercase">Deposit History ({{$currency}})</h4>
                 ...
                 <div class="col-md-12">
                    <div class="panel panel-default noBorder">
                        ...
                        <div class="panel-body">
                            <h4 class="uppercase">Withdrawal History ({{$currency}})</h4>
                            ...
                            <div class="table-responsive">
                                <table id="mytable1" class="table table-striped table-bordered tableBorder" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th>Date</th>
                                            <th>Transaction ID</th>
