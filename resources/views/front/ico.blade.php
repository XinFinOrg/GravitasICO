                    ...
                    <div class="col-lg-12 col-xs-12 col-sm-12">
                        ...
                        <div class="card currency-card-rounded">
                            ...
                            <div class="currency-card-icon pull-right">
                                <i class="fa"><img src="{{URL::asset('front')}}/assets/img/eth.png"></i>
                            </div>
                            <h2>
                                <span>1 ETH = </span> {{number_format($data['ETH_icotoken'],3,'.','')}} GIFT
                            </h2>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="portlet light">
                            <div class="portlet-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="timeddss1">
                                            <h2>CURRENT BONUS : {{$data['Bonus']}}%</h2>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-content card-body">
                                <div class="tab-content clearfix">
                                                    <div class="tab-pane active" id="1b">
                                                        <form id="eth_form" action="{{url('/ico_buy')}}" method="post">
                                                            {{csrf_field()}}
                                                            <div class="col-md-12">
                                                                <div class="form-group leftsd">
                                                                    ...
                                                                    <input id="ETH_second_currency_price"  name="second_currency_price"  value="{{$data['minETH']}}" onKeyUp="convert_price(this.value,'ETH')" placeholder="Amount" class="form-control input-lg">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="timeddss2">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="row">
                        ...
                        <!-- <div class="col-12 col-lg-6 col-md-6 col-sm-6">
                            <div class="box_wrap bg-white text-center">
                                <h5> GIFT SOLD </h5>
                                <p><span><img src="{{URL::asset('front')}}/assets/img/jsd.png" class="igm" alt=""> 2,000,000,000 / <img src="{{URL::asset('front')}}/assets/img/jsd.png" class="igm" alt="">{{$data['GIFT']}}</span></p>
                                <div class="line"></div>
                            </div>
                        </div> -->
                        ...
                        <div class="col-12 col-lg-6 col-md-6 col-sm-6">
                            <div class="box_wrap bg-white text-center">
                                ...
                                <p><a href="{{url('/contact_us')}}">click here</a></p>
                                <div class="line"></div>
                            </div>
                            </div>
                         </div>
