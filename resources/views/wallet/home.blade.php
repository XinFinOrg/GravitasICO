                    ...
                    <div id="sum_box" class="row mbl">
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="panel db mbm" style="cursor: pointer;">
                                <div class="panel-body"><p class="icon">
                                   <i class="fa font50"><img src="{{URL::asset('front')}}/assets/icons/XDC.png" class="stat-icon" style="width: 50px;height: 50px;"></i>
                                </p><h4 class="value"><span>{{$xdc_bal}}</span></h4>

                                    <p class="description">Admin XDC Balance</p>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="panel db mbm" style="cursor: pointer;">
                                <div class="panel-body"><p class="icon">
                                        <i class="fa font50"><img src="{{URL::asset('front')}}/assets/icons/XDC.png" class="stat-icon" style="width: 50px;height: 50px;"></i>
                                    </p><h4 class="value"><span>{{$xdce_bal}}</span></h4>

                                    <p class="description">Admin XDCE Balance</p>
