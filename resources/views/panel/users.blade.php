...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
  ...
  <div class="row">
           ...
           <input type="text" id="min" name="min" value="{{ app('request')->input('min') }}" class="form-control">
        </div>
        <div class="col-md-3">
            <lable>End date</lable>
           <input type="text" id="max" name="max" value="{{ app('request')->input('max') }}" class="form-control">
        </div>
        <div class="col-md-3">
            <lable>Search</lable>
         ...
         {{csrf_field()}}
                                        ...
                                        <div class="table-container">
                                            ...
                                            @foreach($result as $val)
                                               ...
                                               <td>-</td>
                                               @else
                                               <td>{{get_country_name($val->country)}}</td>
                                               @endif
                                               <td>
                                                 @if($val->document_status==0 ||$val->document_status==3)
                                               ...
                                               <td>
                                               <a href="{{url('admin/status_users/'.$val->id)}}" title="status"><i class="fa fa-cog"></i></a>
                                                 <a href="{{url('admin/view_users/'.$val->id)}}" title="view"><i class="fa fa-eye"></i></a>
                                               </td>
                                               </tr>
                                            @endforeach
                                            @endif
