...
@section("content")
    ...
    <div style="float: right"><a href="{{url('admin/user_transaction_details?&type=PDF&user_id='.$id)}}" target="_blank" style="cursor:pointer;">Download</a></div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div style="text-align: center"><p><h2>{{get_user_details($bal->user_id,'enjoyer_name')}}</h2></p>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div style="text-align: center"><p><h2>Explorer Deposit</h2></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel db mbm" style="cursor: pointer;">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div style="text-align: center"><i class="fa fa-exchange fa-6x"></i></div>
                                <div style="text-align: center"><p><h2>Withdrawals</h2></p>
                                    </div>
                            </div>
                        </div>
                        <div class="row">
