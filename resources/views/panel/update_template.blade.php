                            ...
                            <div class="col-md-12">
                                ...
                                <div id="generalTabContent" class="tab-content">
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <form action="{{url('admin/update_template/'.$id)}}" method="post" class="form-horizontal">
                                        ...
                                        {{ csrf_field() }}
                                         ...
                                         <div class="form-group"><label class="col-sm-3 control-label">Title </label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                <div class="col-xs-9"><input type="text" value="{{$result->name}}" class="form-control" readonly="readonly" /></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Subject </label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                <div class="col-xs-9"><input type="text"  name="subject" value="{{$result->subject}}" class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Content </label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                <div class="col-xs-9">
                                                <textarea class="form-control" name="template" id="content">{{$result->template}}</textarea>
                                                </div>
                                                    </div>
                                                </div>
                                            </div>
