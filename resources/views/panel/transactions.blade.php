...
@section("content")
    ...
    <div class="page-content">
        <div class="row">
            <div class="col-md-12">
                <input type="hidden" value="{{url('/admin/delete_transaction')}}" id="url_addrs">
                @include('panel.alert')
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <form id="form_filters" method="get">
                                        ...
                                        <div class="col-md-3">
                                            @if($type == 'Withdraw')
                                            <a style="margin-top: 17px;" class="btn btn-default" href="{{url('/admin/withdraw_history/')}}"><i
                                                        class="fa fa-refresh" ></i></a>&nbsp;
                                            @elseif($type == 'Deposit')
                                                <a style="margin-top: 17px;" class="btn btn-default" href="{{url('/admin/deposit_history/')}}"><i
                                                            class="fa fa-refresh" ></i></a>&nbsp;
                                            @elseif($type == 'Updated')
                                                <a style="margin-top: 17px;" class="btn btn-default" href="{{url('/admin/updated_history/')}}"><i
                                                            class="fa fa-refresh" ></i></a>&nbsp;
                                            @elseif($type == 'Trade')
                                            ...
                                            @foreach($result as $key=>$val)
                                                ...
                                                <tr>
                                                    ...
                                                    @if($val->type=='Withdraw')
                                                        <td>
                                                            <a href="{{url('admin/confirm_transfer/'.$val->id)}}"><i
                                                                        class="fa fa-eye"></i></a>
                                                        </td>
                                                    @elseif($val->type=='Deposit')
                                                        <td>
                                                            <a href="{{url('admin/view_transactions/'.$val->transaction_id)}}"><i
                                                                        class="fa fa-eye"></i></a>&nbsp;
                                                            <a data-toggle="modal" data-target="#confirm_modal" class="open-confirmModal" data-id="{{$val->transaction_id}}"><i
