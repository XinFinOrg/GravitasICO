                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form class="form-horizontal"
                                      action="{{url('admin/confirm_transfer/'.$result->id)}}" method="post">
                                    ...
                                    <div class="panel-body pan">
                                        <div class="form-body pal">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group"><label for="inputLastName"
                                                                                   class="col-md-2 control-label"><strong>User Verified
                                                                :</strong></label>

                                                       @if(get_user_verified($result->user_id)== 'Unverified')
                                                        <div class="col-md-10"><p
                                                                    class="form-control-static"><a href="" id="user_verified" style="color: red" onclick="user_verified()">{{get_user_verified($result->user_id)}}</a></p>
                                                        </div>
                                                        @else
                                                            <div class="col-md-10"><p
                                                                        class="form-control-static"><a href="" id="user_verified" style="color: green" onclick="user_verified()">{{get_user_verified($result->user_id)}}</a></p>
                                                            </div>
                                                           @endif
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group"><label for="inputLastName"
                                                                                   class="col-md-2 control-label"><strong>Transaction Details:</strong></label>

                                                        <div class="col-md-10"><a
                                                                    class="form-control-static"target="_blank" href="{{url('admin/user_transaction_details?user_id='.$result->user_id)}}">click here</a>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('script')
    ...
    <script type="text/javascript">
        function XDCEsubmit()
        {
            window.open('https://etherscan.io/address/0x3a7ebdebaca6393ba2b6b99b6b8c176de8ca237f#tokentxns',"_blank");
            $('form').submit();
        }
    </script>
@endsection
