                            ...
                            <div class="col-md-12">
                                ...
                                @if($view=='add')
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <form action="{{url('admin/add_faq')}}" method="post" class="form-horizontal">
                                        <h3>Add FAQ</h3>
                                        {{ csrf_field() }}
                                         ...
                                         <div class="form-group"><label class="col-sm-3 control-label">Question </label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                <div class="col-xs-9"><input type="text" value="{{old('question')}}" name="question" class="form-control"  /></div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    @endif
                                     ...
                                     @if($view=='edit')
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <form action="{{url('admin/update_faq/'.$id)}}" method="post" class="form-horizontal">
                                        <h3>Update FAQ</h3>
                                        {{ csrf_field() }}
                                         ...
                                         <div class="form-group"><label class="col-sm-3 control-label">Question </label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                <div class="col-xs-9"><input type="text" value="{{$result->question}}" name="question" class="form-control"  /></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Answer </label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                <div class="col-xs-9">
                                                <textarea class="form-control" name="description" id="content">{{$result->description}}</textarea>
                                                </div>
                                                    </div>
                                                </div>
                                            </div>
