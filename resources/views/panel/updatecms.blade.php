...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                <div class="page-header pull-left">
                    <div class="page-title">Update CMS</div>
                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="generalTabContent" class="tab-content">
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <form action="{{url('admin/updatecms/'.$id)}}" method="post" class="form-horizontal">
                                        <h3>Update CMS</h3>
                                        {{ csrf_field() }}
                                         ...
                                         <div class="form-group"><label class="col-sm-3 control-label">Page </label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                <div class="col-xs-9"><input type="text" value="{{$result->link}}" class="form-control" readonly="readonly" /></div>
                                                    </div>
                                                </div>
                                            </div>

                                            <div class="form-group"><label class="col-sm-3 control-label">Heading </label>

                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                <div class="col-xs-9"><input type="text"  name="heading" value="{{$result->heading}}" class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Content </label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                <div class="col-xs-9">
                                                <textarea class="form-control" name="content" id="content">{{$result->content}}</textarea>
                                                </div>
                                                    </div>
                                                </div>
                                            </div>
