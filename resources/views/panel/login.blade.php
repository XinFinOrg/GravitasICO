...
<body id="signin-page">
<div class="page-form">
    <form action="{{url('/admin')}}" class="form" method="post">
...
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    ...
    @endif
        <div class="body-content">
            ...
            <hr>
            <p>Forgotten your Password? <a id="btn-register" href="{{url('admin/forgot')}}">Forgot Now</a></p></div>
    </form>
</div>
