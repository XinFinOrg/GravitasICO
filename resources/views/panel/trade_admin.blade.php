...
@section("content")
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a href="{{url('admin/pending_history')}}">Pending transactions</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>

            <li class="active"><a href="{{url('admin/tradeadmin')}}">New Users</a></li>
        </ol>
                                        ...
                                        @if($result)
                                            @foreach($result as $key=>$val)
                                                <tr>
                                                    ...
                                                    <td>{{$val->user_id}}</td>
                                                    <td><a href="{{url('/admin/view_users/'.$val->user_id)}}">{{get_user_details($val->user_id,'enjoyer_name')}}</a></td>
                                                    <td>{{$val->Amount}}</td>
                                                    <td>{{$val->Price}}</td>
                                                    <td>{{$val->Fee}}</td>
                                                    <td>{{$val->Total}}</td>
                                                    ...
                                                    <td>&nbsp;  <a data-toggle="modal" data-target="#confirm_modal" class="open-confirmModal" data-id="{{$val->id}}"><i class="fa fa-times"></i></a></td>
                                                </tr>
                                            @endforeach
                                        @endif
                                        </tbody>
