                            ...
                            <div class="col-md-12">
                                ...
                                <div id="generalTabContent" class="tab-content">
                                    ...
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <form action="{{url('admin/update_meta/'.$id)}}" method="post" class="form-horizontal">
                                        ...
                                        {{ csrf_field() }}
                                         ...
                                         <div class="form-group"><label class="col-sm-3 control-label">Page </label>
                                                ...
                                                <input type="text" value="{{$result->heading}}" name="heading" readonly class="form-control"  />
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Meta Keywords </label>
                                                ...
                                                <input type="text" value="{{$result->meta_keywords}}" name="meta_keywords" class="form-control"  />
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Meta Descriptions </label>

                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                <div class="col-xs-6">

                                                <textarea class="form-control" name="meta_description">{{$result->meta_description}}</textarea>
