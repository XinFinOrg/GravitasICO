<!DOCTYPE html>
<html lang="en">
<head><title>Control Panel - Gravitas</title>
    <meta charset="utf-8">
...
<body id="signin-page">
<div class="page-form">
    <form action="{{url('/admin/forgot')}}" class="form" method="post">
    ...
    @endif
        <div class="body-content">
            ...
            <div class="form-group">
                <div class="input-icon right"><i class="fa fa-user"></i><input type="email" placeholder="Email" name="forgot_username" class="form-control"></div>
            </div>
            ...
            <hr>
            <p>Back to <a id="btn-register" href="{{url('admin')}}">Login</a></p>
           </div>
    </form>
</div>
