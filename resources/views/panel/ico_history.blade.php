                ...
                <div class="col-sm-6 col-md-6">
                    ...
                    <div class="panel db mbm" style="cursor: pointer;">
                        <div class="panel-body" >
                            <div class="row">
                                <div class="col-md-12">
                                    <div style="text-align: center"><i class="fa font50"><img src="{{URL::asset('front')}}/assets/icons/stats.png" class="stat-icon" style="width: 50px;height: 50px;"></i></div>
                                    <div style="text-align: center"><p><h2>${{$stats['USD']}}</h2></p>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <form id="form_filters" method="get">
                                        ...
                                        <div class="col-md-3">
                                            <a style="margin-top: 17px;" class="btn btn-default" href="{{url('/admin/ico_history/')}}"><i
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="icopriceupdate" method="post" action="{{url('/admin/update_ico_price')}}">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="usdt" id="usdt" value="{{$price['USDT']}}">
                            </div>
