                        ...
                        <div id="tableactionTabContent" class="tab-content">
                             <div id="table-table-tab" class="tab-pane fade in active">
                                <div class="row">
                                    <div class="col-lg-12">
                                     ...
                                     <form class="form-horizontal" method="post" action="{{url('admin/view_kyc/'.$id)}}" >
                                    {{ csrf_field() }}
                                         <h3>KYC Details: </h3>
                            ...
                            <div class="col-md-12">
                                <div class="form-group"><label for="inputFirstName" class="col-md-2 control-label"><strong>First Name:</strong></label>
                                    ...
                                    <div class="col-md-10"><p class="form-control-static">{{$result->first_name}}</p></div>
                                </div>
                            </div> <br>
                            ...
                            <div class="col-md-12">
                                <div class="form-group"><label for="inputLastName" class="col-md-2 control-label"><strong>Gender:</strong></label>
                                    ...
                                    <div class="col-md-10"><p class="form-control-static">{{$result->gender}}</p></div>
                                </div>
                            </div> <br>
                                  ...
                                  <div class="col-md-12">
                                      <div class="form-group"><label for="inputLastName" class="col-md-2 control-label"><strong>Country:</strong></label>
                                          ...
                                          <div class="col-md-10"><p class="form-control-static">{{get_country_name($result->country_code)}}</p></div>
                                      </div>
                                  </div> <br>
                                  ...
                                  <div class="col-md-12">
                                      <div class="form-group"><label for="inputLastName" class="col-md-2 control-label"><strong>ISD Code:</strong></label>
                                          ...
                                          <div class="col-md-10"><p class="form-control-static">{{$result->mob_isd}}</p></div>
                                      </div>
                                  </div> <br>
                                  ...
                                  <div class="col-md-12">
                                      <div class="form-group"><label for="inputLastName" class="col-md-2 control-label"><strong>Mobile No:</strong></label>
                                          ...
                                          <div class="col-md-10"><p class="form-control-static">{{$result->mobile_no}}</p></div>
                                      </div>
                                  </div> <br>
                                  <!-- <div class="col-md-12">
                             ...
                             <div class="col-md-12">
                                <div class="form-group"><label for="inputLastName" class="col-md-2 control-label"><strong>Updated date:</strong></label>
                                    ...
                                    <div class="col-md-10"><p class="form-control-static">{{$result->updated_at}}</p></div>
                                </div>
                            </div>
                           ...
                           <div class="col-md-12">
                             ...
                             <div class="col-md-12">
                                <div class="form-group"><label for="inputLastName" class="col-md-2 control-label"><strong>Proof 1:</strong></label>
                                    ...
                                    <div class="col-md-6"><p class="form-control-static">
                                      <img src="{{URL::asset('uploads/users/documents')}}/{{$result->proof1}}" style="width: 150px;height: 100px;">
                                    </p>
                                    </div>
                                    <div class="col-md-4">
                                    <input type="checkbox" name="proof1_status" @if($result->proof1_status==1) Checked @endif >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group"><label for="inputLastName" class="col-md-2 control-label"><strong>Proof 2:</strong></label>
                                    ...
                                    <div class="col-md-6"><p class="form-control-static">
                                      <img src="{{URL::asset('uploads/users/documents')}}/{{$result->proof2}}" style="width: 150px;height: 100px;">
                                    </p>
                                    </div>
                                    <div class="col-md-4">
                                    <input type="checkbox" name="proof2_status" @if($result->proof2_status==1) Checked @endif >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group"><label for="inputLastName" class="col-md-2 control-label"><strong>Proof 3:</strong></label>
                                    ...
                                    <div class="col-md-6"><p class="form-control-static">
                                      <img src="{{URL::asset('uploads/users/documents')}}/{{$result->proof3}}" style="width: 150px;height: 100px;">
                                    </p>
                                    </div>
                                    <div class="col-md-4">
                                   <input type="checkbox" name="proof3_status" @if($result->proof3_status==1) Checked @endif >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group"><label for="inputLastName" class="col-md-2 control-label"><strong>Over All Status:</strong></label>
                                    ...
                                    <select class="form-control" name="kycstatus" onchange="kycscr(this.value)">
                                        <option value="0" @if($result->document_status==0 || $result->document_status==3)selected @endif>Pending</option>
                                        <option value="1" @if($result->document_status==1)selected @endif >Approve</option>
                                        <option value="2" @if($result->document_status==2)selected @endif>Reject</option>
                                    </select>
                                    </p></div>
                                </div>
                            </div>
