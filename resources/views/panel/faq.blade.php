...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
  ...
  <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="{{url('admin/add_faq')}}" class="btn btn-info pull-right">Add FAQ</a>
                             <div id="table-table-tab" class="tab-pane fade in active">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a href="{{url('admin/update_faq/'.$val->id)}}" title="edit"><i class="fa fa-pencil"></i></a>

                                        <a href="{{url('admin/status_faq/'.$val->id)}}" title="Status"><i class="fa fa-cog"></i></a>

                                        <a href="{{url('admin/delete_faq/'.$val->id)}}" title="delete" onclick="return confirm('Are you sure to delete')"><i class="fa fa-trash-o"></i></a>
                                               </td>
                                               </tr>
                                               @endforeach
                                               @endif
...
{
    window.location.href="{{URL::to('/admin/confirmation')}}";
}
