            ...
            <div class="col-md-12">
                ...
                <div id="tableactionTabContent" class="tab-content">
                    <div id="table-table-tab" class="tab-pane fade in active">
                        <div class="row">
                            <div class="col-lg-12">
                                <input type="hidden" value="{{url('/admin/cancel_trade')}}" id="url_addrs">
                                ...
                                <div class="row">
                                    <form id="form_filters" method="get">
                                        ...
                                        <div class="col-md-3">
                                            <a style="margin-top: 17px;" class="btn btn-default" href="{{url('/admin/pending_history/')}}"><i
                                    ...
                                    <div class="col-md-3">
                                        <button class="pull-right" id="cancel_button" style="margin-top:35px; display:none;" onclick="cancel_multiple()">Cancel Trades</button>
                                        <button class="pull-right" id="checknone" style="margin-top:35px; margin-right:5px; display:none;" onclick="check_none()">None</button>
                                        <button class="pull-right" id="checkall" style="margin-top:35px; margin-right:5px; display:none;" onclick="check_all()">All</button>
                                    </div>
                                </div>
                                        ...
                                        @if($result)
                                            @foreach($result as $key=>$val)
                                                <tr>
                                                    ...
                                                    <td> <a href="{{url('admin/cancel_trade')}}/{{$val->id}}"
                                                            onclick="return confirm('Are you sure want to cancel the order ?')"><i class="fa fa-times"></i></a>&nbsp;&nbsp;<input class="checkbox" type='checkbox' name='checked[]' id="checkbox{{$key}}" value="{{$val->id}}" onclick="check_selected()" "></td>
                                                </tr>
                                            @endforeach
                                        @endif
                                        </tbody>
    ...
    <script type="text/javascript">
        ...
        function cancel_multiple(){
            ...
            if(confirm("Are you sure you want to cancel the trades with the following id:\n"+ id.join("\n"))) {
                window.location.href="/admin/cancel_multiple/"+encodeURIComponent(JSON.stringify(id));
            }
        }
