                            ...
                            <div class="col-md-12">
                                ...
                                <div id="generalTabContent" class="tab-content">
                                    <div id="tab-edit" class="tab-pane fade in active">
                                        <form action="{{url('admin/profile')}}" method="post" class="form-horizontal">
                                        ...
                                        {{ csrf_field() }}
                                            <div class="form-group"><label class="col-sm-3 control-label">Email *</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                 <div class="col-xs-9"><input type="email" placeholder="email@yourcompany.com" class="form-control" name="admin_email" value="{{get_adminprofile('email_id')}}" /></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group"><label class="col-sm-3 control-label">Username *</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="text" placeholder="username" name="admin_username" value="{{get_adminprofile('XDC_username')}}" class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group"><label class="col-sm-3 control-label">Country</label>
                                                ...
                                                <div class="col-sm-9 controls">
                                                    <div class="row">
                                                        <div class="col-xs-9"><input type="text" placeholder="India" name="admin_country" value="{{get_adminprofile('country')}}" class="form-control"/></div>
                                                    </div>
                                                </div>
                                            </div>
