...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
  ...
  <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="table-container">
                                            ...
                                            <th>Actions</th>
                                               ...
                                               <td>
                                             <a href="{{url('admin/delete_whitelist/'.$val->id)}}" title="delete" onclick="return confirm('Are you sure to delete ?')"><i class="fa fa-trash-o"></i></a>
                                               </td>
            ...
            <div id="modal-ip" tabindex="-1" role="dialog" aria-labelledby="modal-login-label" aria-hidden="false" class="modal fade">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form">
                                    ...
                                    <form class="form-horizontal"  method="post" action="{{url('admin/whitelists')}}">
                                       {{ csrf_field() }}
                                        <div class="form-group"><label for="username" class="control-label col-md-3">IP Address</label>

                                            <div class="col-md-9"><input id="ip_addr" name="ip_addr" class="form-control" type="text" required></div>
                                        </div>
