...
@section("content")
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb pull-right">
            <li><i class="fa fa-home"></i>&nbsp;<a href="{{url('admin/userbalance')}}">Users Balance</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </li>

            <li class="active"><a href="{{url('admin/users_balance_validation')}}">Users Valid Balance</a></li>
        </ol>
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <form id="form_filters" method="get">
                                        ...
                                        <div class="col-md-3">
                                            <a style="margin-top: 17px;" class="btn btn-default" href="{{url('/admin/users_balance_validation/')}}"><i
                                                ...
                                                <tr>
                                                    ...
                                                    @else
                                                        <td><a style="cursor: pointer;color: red" class="fa fa-circle"
                                                                onclick="update_userbal({{$user['User_id']}},'{{$user['Currency']}}',{{$user['Actual_Balance']}})"></a></td>
                                                    @endif
                                                    <td>{{$user['Name']}}</td>
